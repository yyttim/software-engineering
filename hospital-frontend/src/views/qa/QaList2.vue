<template>
  <div>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template slot-scope="scope">
            <el-button
                ...
                type="success"
                @click="modifyDialog(scope.row.qaId)"
    ...
    <!-- 发起咨询对话框 -->
    <el-dialog title="发起咨询" :visible.sync="addFormVisible">
      <el-form :model="addForm" :rules="rules" ref="ruleForm">
        <el-form-item label="编号" prop="qaId" label-width="80px">
          <el-input v-model.number="addForm.qaId"></el-input>
        </el-form-item>
        <el-form-item label="标题" prop="qaTitle" label-width="80px">
          <el-input v-model="addForm.qaTitle"></el-input>
        </el-form-item>
        <el-form-item label="内容" prop="qaHistory" label-width="80px">
          <el-input type="textarea"
                    v-model="addForm.qaHistory"
                    autosize
          ></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        ...
        <el-button size="mini" type="primary" @click="addQa('ruleForm')"style="font-size: 18px;">
    ...
    <el-dialog title="咨询记录" :visible.sync="modifyFormVisible">
      <div>
        <p style="white-space: pre-wrap;">{{ modifyForm.qaHistory ? modifyForm.qaHistory.replaceAll(modifyForm.pName, '我') : modifyForm.qaHistory }}</p>
      </div>
      ...
      request
          ...
          .then((res) => {
            ...
            this.qaData.forEach((item, index) => {
              this.qaData[index].qaHistory = this.qaData[index].qaHistory.replaceAll(this.qaData[index].pName, '我');
            });
