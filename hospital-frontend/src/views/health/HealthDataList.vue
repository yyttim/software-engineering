  ...
  <div>
    <el-card>
      ...
      <el-table :data="healthData" size="small" stripe style="width: 100%" border>
        ...
        <el-table-column label="用户id" prop="pId"/>
        ...
        <el-table-column label="健康建议" width="450">
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template slot-scope="scope">
            <el-button
                ...
                type="danger"
                @click="deleteDialog(scope.row.hdId)"
  ...
  methods: {
    ...
    requestHealthDatas() {
      request
          ...
          .then((res) => {
            this.healthData = res.data.data.healthDatas;
